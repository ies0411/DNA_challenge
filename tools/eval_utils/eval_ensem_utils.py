...
def eval_one_epoch(
    cfg_1,cfg_2, args, model_1,model_2, dataloader, epoch_id, logger, dist_test=False, result_dir=None
):
    ...
    for cur_thresh in cfg_1.MODEL.POST_PROCESSING.RECALL_THRESH_LIST:
    ...
    for i, batch_dict in enumerate(dataloader):
        ...
        with torch.no_grad():
            pred_dicts_1, ret_dict_1 = model_1(batch_dict)
            pred_dicts_2, ret_dict_2 = model_2(batch_dict)
